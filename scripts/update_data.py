...
# BTC via CoinGecko
print("  Fetching BTC (CoinGecko)...")
btc_price = fetch_btc_coingecko()
if btc_price:
    data["btc"]["price"] = btc_price
...
<meta http-equiv="refresh" content="1800"><!-- 每30分鐘瀏覽器自動刷新 -->
...
<div class="h-inner">
  ...
  <div class="update-badge">⟳ 最後更新：{updated_at} · 每日 09:00 &amp; 17:00 SGT 自動刷新</div>
  <div class="kpi-row">
    <div class="kpi">
...
<table>
  ...
  <tbody>
    {row("🇹🇼","台積電 TSMC","2330.TW · 台灣","tsmc",
         target="TWD 2,290",analyst_note="31分析師共識 · +21%",
    ...
    {row("✈️","新航 SIA","C6L.SI · SGX","sia",
         target="SGD 7.157",analyst_note="GrowBeanSprout · +9%",
    ...
    {row("🏦","DBS 星展","D05.SI · SGX","dbs",
         target="SGD 61.10",analyst_note="GrowBeanSprout · +10.5%",
...
<div class="footer">
  ...
  戰前基準數據（02-27）已人工驗證，不參與自動更新。最新價格每日 09:00 &amp; 17:00 SGT 自動更新。<br>
